...
- The main model owns orchestration, synthesis, and the outcome end to end. Do ordinary work directly; spawn a named custom agent only when bounded delegation clearly improves quality, speed, independence, or context.
